...
/* 	|initParams.hpp                    |yysssso////  /syyyyyyyyyyyyyyy0    /yhhhhhyyyyyyyyyyyyyyyyyy|  */
...
#ifndef INITPARAMS_HPP
#define	INITPARAMS_HPP
...
const unsigned int	indxInitGNSS = 12; // значение для накопления позиции по ГНСС
